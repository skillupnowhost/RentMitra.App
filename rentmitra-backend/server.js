...
const productPricingRoutes = require('./src/productPricing');
...
// src/productPricing.js for everything under /products and
// /product-variants, public and /admin.
app.use(productPricingRoutes);
